    ...
    return (
        <div className="container mx-auto p-6 text-gray-800">
            <div className="rounded-lg p-6 text-center">
                ...
                <p className="text-md text-gray-600">Please note that this is not the final booking. You will receive a confirmation email once the tailor confirms your appointment.</p>
            </div>
        </div>
    );
};
